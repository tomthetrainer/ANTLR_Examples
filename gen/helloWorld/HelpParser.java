...
public class HelpParser extends Parser {
	...
	public static class RContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(HelpParser.ID, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HelpListener ) ((HelpListener)listener).enterR(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HelpListener ) ((HelpListener)listener).exitR(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HelpVisitor ) return ((HelpVisitor<? extends T>)visitor).visitR(this);
